...
import { editRecepProfile, receptionistResetPassword } from '../../services/ReceptionistApi';
...
export default function RecepProfile() {
  ...
  async function handleClick(e: React.MouseEvent<HTMLButtonElement>) {
    e.preventDefault();
    const res = await editRecepProfile(user._id, {
      username: name,
      email,
      address,
      mobileNumber: phone,
  ...
  async function handleChangePassword(e: React.MouseEvent<HTMLButtonElement>) {
    ...
    try {
      const res = await receptionistResetPassword({
        email,
